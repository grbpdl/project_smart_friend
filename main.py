...
img = pygame.image.load('Intro.jpg')
img=pygame.transform.scale(img,(WIDTH,HEIGHT))
rect = img.get_rect()
img2 = pygame.image.load('Result.jpg')
img2=pygame.transform.scale(img2,(WIDTH,HEIGHT))
rect2 = img2.get_rect()
img3 = pygame.image.load('mat11.png')
img3=pygame.transform.scale(img3,(WIDTH,HEIGHT))
rect3 = img3.get_rect()
img4 = pygame.image.load('mat2.png')
img4=pygame.transform.scale(img4,(WIDTH,HEIGHT))
rect4 = img4.get_rect()
ready = pygame.image.load('mat3.png')
...
class gamestate:
    def __init__(self):
        ...
        self.username=''
        self.useremail=''
        self.select_sound=mixer.Sound('clickselect.mp3')
        self.process_sound=mixer.Sound('process.mp3')
        self.reveal_sound=mixer.Sound('spb.mp3')
...
PS:Have the guts and be positive,fordward this love mail to your crush!Wishing you best of luck!
    -yours Smart Friend'''
            ...
            App.t.draw()
            App.t = Text('Yubraj Adhikari',(20,330),None,30,(173,216,230))
            App.t.draw()
            App.t = Text('Binay Rijal',(20,360),None,30,(173,216,230))
            App.t.draw()
            App.t = Text('Suman Sharma',(20,390),None,30,(173,216,230))
            App.t.draw()
            App.t = Text('Gaurab Paudyal',(20,420),None,30,(173,216,230))
            App.t.draw()
...
class App:
    def __init__(self):
            ...
            App.running = True
            self.bg_sound=mixer.Sound('smoothbg.mp3')
